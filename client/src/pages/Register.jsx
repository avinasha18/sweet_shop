...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-pink-50 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <div>
          <motion.div
            className="mx-auto h-12 w-12 bg-gradient-to-r from-emerald-400 to-emerald-600 rounded-full flex items-center justify-center"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          >
            Create your account to start exploring delicious sweets
          </motion.p>
        </div>
